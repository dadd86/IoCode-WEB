...
export type PortfolioPageCopy = {
  ...
  intro: string;
  imageAlt: string;
  // Confidential/industrial work has no public repository and therefore no
  // Project entry (see createProject() below); this routes interest to
  // Contact instead of fabricating a ninth, evidence-less project.
  confidentialCta: {
    heading: string;
    text: string;
    ctaLabel: string;
...
export const portfolioPageCopy: Record<Locale, PortfolioPageCopy> = {
  es: {
    title: "Proyectos de software, datos y automatización | IoCode",
    description:
      "Una selección de proyectos que muestra cómo se resuelven retos de arquitectura, integración, datos y calidad con decisiones técnicas claras y código verificable.",
    eyebrow: "Proyectos seleccionados",
    heading: "Software, datos y automatización llevados a la práctica.",
    intro:
      "Cada caso separa el problema, la decisión de ingeniería detrás de la solución y lo que puede revisarse directamente en el repositorio público.",
    imageAlt: "Proyectos de software, datos y automatización de IoCode SOLUTIONS",
    confidentialCta: {
      heading: "Experiencia industrial no publicable",
      text: "¿Buscas ejemplos de trabajo industrial que no pueden publicarse en GitHub? Puedo explicar arquitectura, alcance y decisiones técnicas bajo solicitud, respetando los compromisos de confidencialidad.",
      ctaLabel: "Hablar sobre tu proyecto"
    }
  },
  en: {
    title: "Software, data & automation projects | IoCode",
    description:
      "A selection of projects showing how architecture, integration, data and quality challenges are solved through clear engineering decisions and inspectable code.",
    eyebrow: "Selected projects",
    heading: "Software, data and automation put into practice.",
    intro:
      "Each case separates the problem, the engineering decisions behind it and what you can inspect directly in the public repository.",
    imageAlt: "Software, data and automation projects by IoCode SOLUTIONS",
    confidentialCta: {
      heading: "Industrial work beyond the public portfolio",
      text: "Looking for industrial work that cannot be published on GitHub? Architecture, scope and engineering decisions can be discussed on request, subject to confidentiality obligations.",
      ctaLabel: "Discuss your project"
    }
  },
  de: {
    title: "Software-, Daten- & Automatisierungsprojekte | IoCode",
    description:
      "Ausgewählte Projekte zeigen, wie Herausforderungen in Architektur, Integration, Daten und Qualität mit klaren technischen Entscheidungen gelöst werden.",
    eyebrow: "Ausgewählte Projekte",
    heading: "Software, Daten und Automatisierung in der Praxis.",
    intro:
      "Jeder Fall trennt das Problem, die technische Entscheidung dahinter und das, was sich direkt im öffentlichen Repository prüfen lässt.",
    imageAlt: "Software-, Daten- und Automatisierungsprojekte von IoCode SOLUTIONS",
    confidentialCta: {
      heading: "Industrieprojekte außerhalb des öffentlichen Portfolios",
      text: "Sie möchten Einblicke in Industrieprojekte, die nicht auf GitHub veröffentlicht werden dürfen? Architektur, Umfang und technische Entscheidungen können auf Anfrage unter Wahrung bestehender Vertraulichkeitsvereinbarungen erläutert werden.",
...
const projectSeeds: ProjectSeed[] = [
  {
    ...
    copy: {
      es: {
        ...
        scope: "Gates de build, seguridad y accesibilidad ejecutados y verificados sobre cada release candidato, listos para gobernar el despliegue productivo.",
      ...
      en: {
        ...
        scope: "Build, security and accessibility gates executed and verified on every candidate release, ready to govern production deployment.",
      ...
      de: {
        ...
        scope: "Build-, Sicherheits- und Accessibility-Gates, die bei jedem Kandidaten-Release ausgeführt und verifiziert werden und das Produktiv-Deployment steuern.",
  ...
  },
  {
    ...
    copy: {
      es: {
        ...
        scope: "Arquitectura Android por capas con persistencia offline, gestión de identidad y separación de responsabilidades para una base mantenible y extensible.",
      ...
      en: {
        ...
        scope: "Layered Android architecture with offline persistence, identity management and clear separation of responsibilities for a maintainable, extensible codebase.",
      ...
      de: {
        ...
        scope: "Geschichtete Android-Architektur mit Offline-Persistenz, Identitätsverwaltung und klarer Aufgabentrennung für eine wartbare, erweiterbare Codebasis.",
  ...
  },
  {
    ...
    copy: {
      es: {
        ...
        summary: "Entorno que conecta una API .NET, un módulo Odoo, SQL Server y PostgreSQL mediante Docker Compose.",
        ...
        businessValue: "El Compose público documenta cinco servicios coordinados y separa inicialización, persistencia y ejecución de forma reproducible.",
        evidenceSummary: "Repositorio con C#, Python, T-SQL, módulo Odoo, pruebas, XML, Dockerfiles y Compose público.",
        scope: "Arquitectura ERP multi-servicio que coordina una API .NET, un módulo Odoo y bases SQL Server/PostgreSQL, con Docker Compose configurado para despliegue reproducible.",
      ...
      en: {
        ...
        summary: "Integration environment connecting a .NET API, an Odoo module, SQL Server and PostgreSQL through Docker Compose.",
        ...
        businessValue: "The public Compose file coordinates five services and reproducibly separates initialization, persistence and runtime.",
        evidenceSummary: "Repository with C#, Python, T-SQL, an Odoo module, tests, XML, Dockerfiles and public Compose configuration.",
        scope: "Multi-service ERP architecture coordinating a .NET API, an Odoo module and SQL Server/PostgreSQL data stores, with Docker Compose configured for reproducible deployment.",
      ...
      de: {
        ...
        summary: "Integrationsumgebung mit .NET-API, Odoo-Modul, SQL Server und PostgreSQL unter Docker Compose.",
        ...
        scope: "Multi-Service-ERP-Architektur, die eine .NET-API, ein Odoo-Modul und SQL Server-/PostgreSQL-Datenbanken koordiniert, mit für reproduzierbares Deployment konfiguriertem Docker Compose.",
  ...
  },
  {
    ...
    copy: {
      es: {
        ...
        summary: "Modelo de dominio de tiendas, almacenes, productos, proveedores, clientes y ventas mediante clases Java especializadas.",
        ...
        scope: "Modelado de dominio orientado a objetos en Java, con herencia y clases especializadas que separan inventario, clientes, proveedores y ventas.",
      ...
      en: {
        ...
        summary: "Domain model for stores, warehouses, products, suppliers, customers and sales using specialized Java classes.",
        ...
        scope: "Object-oriented domain modelling in Java, with inheritance and specialized classes separating inventory, customers, suppliers and sales.",
      ...
      de: {
        ...
        summary: "Domänenmodell für Filialen, Lager, Produkte, Lieferanten, Kunden und Verkäufe mit spezialisierten Java-Klassen.",
        ...
        scope: "Objektorientierte Domänenmodellierung in Java mit Vererbung und spezialisierten Klassen, die Bestand, Kunden, Lieferanten und Verkäufe trennen.",
  ...
  },
  {
    ...
    featured: false,
    copy: {
      es: { slug: "alquiler-vehiculos-java-oop", title: "Alquiler de vehículos: Java OOP", type: "Modelado de flota y contratos", summary: "Aplicación que modela agencia, flota, clientes, contratos y varios tipos de vehículo.", problem: "Gestionar coches, motos y camiones con reglas comunes sin duplicar estructura ni lógica contractual.", solution: "Jerarquía Java de vehículos, clases de agencia, flota, cliente y contrato de alquiler.", technicalRole: "Diseño orientado a objetos, herencia, encapsulación y operaciones sobre flota y contratos.", businessValue: "El código público separa vehículos, clientes, flota y contratación en nueve clases identificables.", evidenceSummary: "Fuentes Java públicas para Agencia, Flota, Vehículo, Coche, Moto, Camión, Cliente y ContratoAlquiler.", scope: "Modelado de flota y contratos en Java mediante herencia y encapsulación, con clases separadas para agencia, cliente, vehículo y contrato.", seoTitle: "Gestión de flota con Java OOP | IoCode", seoDescription: "Caso Java OOP para agencia, flota, clientes, contratos, coches, motos y camiones mediante herencia y responsabilidades separadas.", keywords: ["Java OOP", "gestión de flota", "herencia", "contratos", "NetBeans"], schemaType: "SoftwareSourceCode", imageAlt: "Jerarquía Java de vehículos, flota y contratos de alquiler" },
      en: { slug: "vehicle-rental-java-oop", title: "Vehicle rental: Java OOP", type: "Fleet and contract modelling", summary: "Application modelling an agency, fleet, customers, rental contracts and several vehicle types.", problem: "Manage cars, motorcycles and trucks with shared rules without duplicating structure or contract logic.", solution: "Java vehicle hierarchy plus agency, fleet, customer and rental-contract classes.", technicalRole: "Object-oriented design, inheritance, encapsulation and fleet/contract operations.", businessValue: "The public code separates vehicles, customers, fleet and contracting into nine identifiable classes.", evidenceSummary: "Public Java sources for Agency, Fleet, Vehicle, Car, Motorcycle, Truck, Customer and RentalContract.", scope: "Fleet and contract modelling in Java through inheritance and encapsulation, with separate classes for agency, customer, vehicle and contract.", seoTitle: "Fleet management with Java OOP | IoCode", seoDescription: "Java OOP case for agencies, fleets, customers, contracts, cars, motorcycles and trucks using inheritance and separated responsibilities.", keywords: ["Java OOP", "fleet management", "inheritance", "contracts", "NetBeans"], schemaType: "SoftwareSourceCode", imageAlt: "Java hierarchy for vehicles, fleets and rental contracts" },
      de: { slug: "fahrzeugvermietung-java-oop", title: "Fahrzeugvermietung: Java OOP", type: "Flotten- und Vertragsmodellierung", summary: "Anwendung für Agentur, Flotte, Kunden, Mietverträge und unterschiedliche Fahrzeugtypen.", problem: "Pkw, Motorräder und Lkw mit gemeinsamen Regeln verwalten, ohne Struktur oder Vertragslogik zu duplizieren.", solution: "Java-Fahrzeughierarchie sowie Klassen für Agentur, Flotte, Kunde und Mietvertrag.", technicalRole: "Objektorientierter Entwurf, Vererbung, Kapselung und Operationen für Flotte und Verträge.", businessValue: "Der öffentliche Code trennt Fahrzeuge, Kunden, Flotte und Vermietung in neun erkennbare Klassen.", evidenceSummary: "Öffentliche Java-Quellen für Agentur, Flotte, Fahrzeug, Pkw, Motorrad, Lkw, Kunde und Mietvertrag.", scope: "Flotten- und Vertragsmodellierung in Java mittels Vererbung und Kapselung, mit getrennten Klassen für Agentur, Kunde, Fahrzeug und Vertrag.", seoTitle: "Flottenverwaltung mit Java OOP | IoCode", seoDescription: "Java-OOP-Fallstudie für Agentur, Flotte, Kunden, Verträge, Pkw, Motorräder und Lkw mit Vererbung und klaren Verantwortungen.", keywords: ["Java OOP", "Flottenverwaltung", "Vererbung", "Mietverträge", "NetBeans"], schemaType: "SoftwareSourceCode", imageAlt: "Java-Hierarchie für Fahrzeuge, Flotte und Mietverträge" }
    }
  },
  {
    key: "the-javengers",
  ...
  },
  {
    ...
    featured: false,
    copy: {
      es: { slug: "juego-python-rompecajas", title: "RompeCajas: juego modular en Python", type: "Python, escenas y animación", summary: "Juego 2D modular estructurado con componentes separados para jugador, escenas, animaciones y gestión de color.", problem: "Evitar que bucle, estado del jugador, animaciones y representación visual queden mezclados en un único script.", solution: "Separación en módulos Python para Player, Scene, Animation y ColorManager coordinados desde el punto de entrada.", technicalRole: "Organización modular, lógica de interacción, escenas y animación con Python.", businessValue: "El repositorio demuestra descomposición funcional en seis fuentes Python en lugar de un script monolítico.", evidenceSummary: "Código público con main.py, Player.py, Scene.py, Animation.py y ColorManager.py.", scope: "Organización modular en Python para escenas, estado del jugador y animación, separando lógica de interacción y representación visual en módulos independientes.", seoTitle: "Juego modular con Python y Pygame | IoCode", seoDescription: "Caso Python con Pygame, escenas, jugador, animaciones y gestión de color organizado en módulos pequeños y verificables.", keywords: ["Python", "Pygame", "scene management", "animación", "programación modular"], schemaType: "SoftwareSourceCode", imageAlt: "Módulos Python de escenas, jugador y animación del juego RompeCajas" },
      en: { slug: "python-break-boxes-game", title: "Break Boxes: modular Python game", type: "Python, scenes and animation", summary: "Modular 2D game structured into separate components for player state, scenes, animations and colour management.", problem: "Avoid mixing the game loop, player state, animation and visual representation inside one script.", solution: "Separate Python modules for Player, Scene, Animation and ColorManager coordinated by the entry point.", technicalRole: "Modular organization, interaction logic, scenes and animation with Python.", businessValue: "The repository demonstrates functional decomposition across six Python sources instead of one monolithic script.", evidenceSummary: "Public code with main.py, Player.py, Scene.py, Animation.py and ColorManager.py.", scope: "Modular Python organization for scenes, player state and animation, separating interaction logic and visual representation into independent modules.", seoTitle: "Modular game with Python and Pygame | IoCode", seoDescription: "Python case with Pygame, scenes, player state, animations and colour management organized into small, verifiable modules.", keywords: ["Python", "Pygame", "scene management", "animation", "modular programming"], schemaType: "SoftwareSourceCode", imageAlt: "Python scene, player and animation modules in the Break Boxes game" },
      de: { slug: "python-spiel-kistenbrechen", title: "Kistenbrechen: modulares Python-Spiel", type: "Python, Szenen und Animation", summary: "Modulares 2D-Spiel mit getrennten Komponenten für Spielerzustand, Szenen, Animationen und Farbverwaltung.", problem: "Game Loop, Spielerzustand, Animation und visuelle Darstellung nicht in einem Skript vermischen.", solution: "Getrennte Python-Module für Player, Scene, Animation und ColorManager, koordiniert durch den Einstiegspunkt.", technicalRole: "Modulare Organisation, Interaktionslogik, Szenen und Animation mit Python.", businessValue: "Das Repository belegt funktionale Zerlegung in sechs Python-Quellen statt eines monolithischen Skripts.", evidenceSummary: "Öffentlicher Code mit main.py, Player.py, Scene.py, Animation.py und ColorManager.py.", scope: "Modulare Python-Organisation für Szenen, Spielerzustand und Animation, die Interaktionslogik und visuelle Darstellung in unabhängige Module trennt.", seoTitle: "Modulares Spiel mit Python und Pygame | IoCode", seoDescription: "Python-Fallstudie mit Pygame, Szenen, Spielerzustand, Animationen und Farbverwaltung in kleinen, prüfbaren Modulen.", keywords: ["Python", "Pygame", "Szenenverwaltung", "Animation", "modulare Programmierung"], schemaType: "SoftwareSourceCode", imageAlt: "Python-Module für Szenen, Spieler und Animation im Spiel Kistenbrechen" }
    }
  }
];
...
function createProject(seed: ProjectSeed, locale: Locale): Project {
  ...
  return {
    ...
    // Repository metadata stays on the locale-independent seed so ES, EN and
    // DE always resolve to the same canonical GitHub repository.
