  ...
  },
  {
    ...
    copy: {
      es: {
        ...
        scope: "Proyecto de ingeniería orientado a demostrar arquitectura Android por capas, persistencia, identidad y prácticas de desarrollo mantenible.",
      ...
      en: {
        ...
        scope: "Engineering project focused on demonstrating layered Android architecture, persistence, identity handling and maintainable development practices.",
      ...
      de: {
        ...
        scope: "Engineering-Projekt zur Demonstration einer geschichteten Android-Architektur, Persistenz, Identitätsverwaltung und wartbarer Entwicklungspraxis.",
  ...
  },
  {
    ...
    copy: {
      es: {
        ...
        scope: "Laboratorio de integración orientado a demostrar arquitectura ERP multi-servicio, coordinación de datos y reproducibilidad con Docker Compose.",
      ...
      en: {
        ...
        scope: "Integration lab focused on demonstrating multi-service ERP architecture, data coordination and reproducibility with Docker Compose.",
      ...
      de: {
        ...
        scope: "Integrations-Lab zur Demonstration einer Multi-Service-ERP-Architektur, Datenkoordination und Reproduzierbarkeit mit Docker Compose.",
  ...
  },
  {
    ...
    copy: {
      es: {
        ...
        scope: "Proyecto de ingeniería orientado a demostrar modelado de dominio orientado a objetos y separación de responsabilidades en Java.",
      ...
      en: {
        ...
        scope: "Engineering project focused on demonstrating object-oriented domain modelling and separation of responsibilities in Java.",
      ...
      de: {
        ...
        scope: "Engineering-Projekt zur Demonstration objektorientierter Domänenmodellierung und Aufgabentrennung in Java.",
