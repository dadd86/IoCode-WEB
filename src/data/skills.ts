...
const skillSeeds: SkillSeed[] = [
  {
    ...
    copy: {
      es: {
        ...
        scope: "Aplicación profesional en programación PLC/HMI, diagnóstico de secuencias y Motion Control, respaldada por experiencia industrial declarada con Siemens, Omron y Rockwell."
      },
      en: {
        ...
        scope: "Professional application of PLC/HMI programming, sequence diagnostics and Motion Control, backed by declared industrial experience with Siemens, Omron and Rockwell."
      },
      de: {
        ...
        scope: "Professionelle Anwendung von SPS-/HMI-Programmierung, Ablaufdiagnose und Motion Control, gestützt auf deklarierte Industrieerfahrung mit Siemens, Omron und Rockwell."
      }
    }
  },
  {
    ...
    copy: {
      es: {
        ...
        scope: "Experiencia centrada en EtherCAT, OPC UA, Profinet y comunicación IT/OT para integración y diagnóstico de sistemas industriales, aplicada siempre con validación sobre el hardware y la topología reales de cada proyecto."
      },
      en: {
        ...
        scope: "Experience centred on EtherCAT, OPC UA, Profinet and IT/OT communication for integrating and diagnosing industrial systems, always applied with validation against the real hardware and topology of each project."
      },
      de: {
        ...
        scope: "Erfahrung mit EtherCAT, OPC UA, Profinet und IT/OT-Kommunikation für Integration und Diagnose industrieller Systeme, stets mit Validierung auf der realen Hardware und Topologie jedes Projekts angewendet."
      }
    }
  },
  {
