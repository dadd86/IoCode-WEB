...
La fuente `src/i18n/routes.ts` declara **11 claves de ruta**: 9 comerciales y 2 legales. Cada clave tiene una variante en los 3 locales, por lo que existen **33 rutas localizadas**: 27 comerciales y 6 legales. El build genera **38 páginas HTML**: las 33 de contenido, tres 404 localizados, la entrada raíz y el fallback 404 global.
