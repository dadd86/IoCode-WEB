...
| Aviso legal (§5 DDG) | `PUBLIC_LEGAL_NAME`, `PUBLIC_LEGAL_BUSINESS_NAME`, `PUBLIC_LEGAL_FORM`, `PUBLIC_LEGAL_STREET`, `PUBLIC_LEGAL_POSTAL_CODE`, `PUBLIC_LEGAL_CITY`, `PUBLIC_LEGAL_COUNTRY`, `PUBLIC_LEGAL_EMAIL`, `PUBLIC_LEGAL_PHONE`, `PUBLIC_LEGAL_VAT_ID` |
