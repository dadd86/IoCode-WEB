...
| Aviso legal (§5 DDG) | `PUBLIC_LEGAL_NAME`, `PUBLIC_LEGAL_BUSINESS_NAME`, `PUBLIC_LEGAL_FORM`, `PUBLIC_LEGAL_REPRESENTATIVE`, `PUBLIC_LEGAL_STREET`, `PUBLIC_LEGAL_POSTAL_CODE`, `PUBLIC_LEGAL_CITY`, `PUBLIC_LEGAL_COUNTRY`, `PUBLIC_LEGAL_EMAIL`, `PUBLIC_LEGAL_PHONE`, `PUBLIC_LEGAL_VAT_ID`, `PUBLIC_LEGAL_REGISTER_NAME`, `PUBLIC_LEGAL_REGISTER_NUMBER` |
| Privacidad (RGPD Art. 13) | `PUBLIC_PRIVACY_EMAIL`, `PUBLIC_HOSTING_PROVIDER`, `PUBLIC_HOSTING_LOCATION`, `PUBLIC_HOSTING_TRANSFER_SAFEGUARD`, `PUBLIC_EMAIL_PROVIDER`, `PUBLIC_EMAIL_LOCATION`, `PUBLIC_EMAIL_TRANSFER_SAFEGUARD`, `PUBLIC_DNS_PROVIDER`, `PUBLIC_DNS_LOCATION`, `PUBLIC_DNS_TRANSFER_SAFEGUARD`, `PUBLIC_REGISTRAR_PROVIDER`, `PUBLIC_REGISTRAR_LOCATION`, `PUBLIC_REGISTRAR_TRANSFER_SAFEGUARD` |
